---
Title: How to write a UTF-8 safe AWK
Date: 2024-04-26
---
<title>A guide on writing a UTF-8 safe awk</title>
## A guide on writing a UTF-8 safe awk

One of the things toybox prioritizes is unicode handling for it's
applications.  This has kept things like [the fully GNU compatible
tr](http://lists.landley.net/pipermail/toybox-landley.net/2023-October/029845.html)
...
This work was [originally done by me](https://github.com/raygard/wak/commit/2e94cd3de8fb4d091ca19bb429cb4b2cb9d6a80e)
...
You might wanna look at [the actual code which does this](https://github.com/raygard/wak/commit/2e94cd3de8fb4d091ca19bb429cb4b2cb9d6a80e), as that might explain it better than I could.
...
is figuring out _what_ needs unicode handling. So here is a guide on not only
what needs unicode handling in a unicode safe awk, but a general guide on how
to implement handling for it too.
